        ...
        {isInitializing && (
          ...
          >
            ...
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-headline font-bold tracking-tight animate-pulse text-foreground">Initializing Instructor Engine</h2>
              <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-[0.4em]">Instructor Console v2.0</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>

      <SidebarProvider style={{ '--sidebar-width': '16rem' } as React.CSSProperties} className="w-full overflow-x-hidden">
        <AdminSidebar />
        <SidebarInset className="bg-muted/10 relative overflow-x-hidden min-w-0 w-full">
          ...
          <header className="flex h-16 shrink-0 items-center gap-2 md:gap-4 border-b bg-background/60 backdrop-blur-xl px-3 md:px-6 sticky top-0 z-50">
            ...
            <div className="flex-1 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <h1 className="font-headline font-bold text-base md:text-xl tracking-tight text-foreground">Instructor Console v2.0</h1>
                <Badge variant="outline" className="text-[10px] h-5 bg-muted/5 text-foreground border-muted/20 font-bold uppercase hidden sm:inline-flex">Status: Online</Badge>
              </div>
              <div className="flex items-center gap-3">
                ...
                <Button size="sm" className="bg-muted text-foreground shadow-lg shadow-muted/20 font-bold text-xs md:text-sm">
                  ...
                  <span className="hidden sm:inline">Refresh</span> Stats
                </Button>
              </div>
            </div>
          </header>
          
          <main className="flex flex-1 flex-col gap-4 md:gap-6 p-3 md:p-6 lg:p-8 relative z-10 min-w-0 w-full overflow-x-hidden">
            <Tabs defaultValue="overview" className="space-y-6">
              ...
              <TabsContent value="overview" className="space-y-6 mt-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 w-full min-w-0">
                  <div className="dashboard-overview-widget min-w-0">
                    <StatCard 
                  ...
                  <div className="dashboard-performance-widget min-w-0">
                    <StatCard 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-6 w-full min-w-0">
